...
export const LoginPage: React.FC = () => {
  ...
  const onSubmit = async (data: LoginFormData) => {
    console.log("[v0] Login form submitted with:", data)
    setIsLoading(true)
    setLoginError("")
    ...
    try {
      ...
      if (!success) {
        ...
        console.log("[v0] Login successful → expecting redirect/navigation")
      }
    } catch (error) {
      console.error("[v0] Login threw error:", error)
      setLoginError("Login failed. Please try again.")
    } finally {
      setIsLoading(false)
      console.log("[v0] Login request finished, loading state:", false)
    }
  }
