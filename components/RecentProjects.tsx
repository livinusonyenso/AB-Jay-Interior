...
import { ArrowRight, MapPin, Tag, X, ChevronLeft, ChevronRight } from 'lucide-react';
    ...
    <>
      ...
      {isModalOpen && currentProject && (
        ...
        >
          ...
          {/* Modal Content */}
          <div 
            className={`relative max-w-6xl max-h-[90vh] w-full transform transition-all duration-500 ${
            ...
            <div className="relative bg-white rounded-2xl overflow-hidden shadow-2xl">
              <div className="relative">
                ...
                <div className="absolute top-6 left-6">
                  <span className={`px-4 py-2 rounded-full text-sm font-medium ${getCategoryColor(currentProject.category)} backdrop-blur-md bg-opacity-90`}>
